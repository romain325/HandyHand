...
/**
 * A class to define the Leaf gesture
 */
public class Leaf  implements IGesture {
    /**
     * A method to know if a hand is doing a Leaf gesture in the frame
     * @param frame The Frame we want the information of
     * @param hand The type of the hand that we want the gesture
     * @return True if a hand is doing a Leaf gesture in the frame, false otherwise
     */
    @Override
